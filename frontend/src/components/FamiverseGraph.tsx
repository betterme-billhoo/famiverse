...
export default function FamiverseGraph() {
  ...
  const getWelcomeGuideContent = () => {
    return {
      name: "欢迎来到 “家庭星球”",
      description: `你好，我是第六代星际导航人工智能 —— MOSS。
                    在接下来的旅程中，我将协助你探索这片浩瀚无垠的宇宙。
                    据我目前所知，宇宙中存在着六大核心星系：德行星系、智慧星系、身体星系、心灵星系、美育星系，以及实践星系。
                    在每一个星系中，都有无数未知的星球等待着你去发现与探索。
                    你可以借助我的星际跃迁功能，在这些星球之间自由穿梭，开启一段段精彩的旅程。
                    在旅途中，你将收获无数珍贵的宝藏，了解并学习众多有趣的知识，使用它们来应对各种实践挑战；你甚至有机会发现全新的星系。
