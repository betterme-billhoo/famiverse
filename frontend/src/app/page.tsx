...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen overflow-hidden bg-black relative"> {/* 确保有 relative 定位 */}
      ...
      {/* 只有在客户端挂载后才渲染 FamiverseGraph 和 GitHub 链接 */}
      {isClient && (
        <>
          <FamiverseGraph />
          ...
          <a
            ...
            className="absolute top-4 left-1/2 -translate-x-1/2 z-20 text-white hover:text-gray-300 transition-colors flex items-center justify-center"
